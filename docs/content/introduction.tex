...
\todo{Is it okay to keep this part so short? mention that \cite{StableFluids}
introduced the Semi-Lagrangian step that we also use for advection, or that's
unnecessary?}
...
Lagrangian particles, they represent \todo{velocity and vorticity} using a basis of
...
\todo{Should we write about our contribution here? ($\approx$using physics-based gradients of
