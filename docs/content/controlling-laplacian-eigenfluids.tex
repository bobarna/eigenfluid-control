...
First, we overfit the \ac{NN} to single training sample. We plot the results of
...
\begin{figure}
  ...
  \end{subfigure}
  \caption{Time evolutions of simulating an overfitted CFE NN to a single shape
  transition}
