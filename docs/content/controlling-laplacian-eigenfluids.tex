...
angle and velocity of a projectile to hit some target \todo{Learning to Throw
figure + description}. For a more involved example we can also think of finding
