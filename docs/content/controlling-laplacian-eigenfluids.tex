...
equation}) to derive gradients used for optimization. Our main proposition is to
...
We overfit the \ac{NN} to single training sample. We plot the results of
...
\begin{figure}
  ...
  a single shape transition. Using $O=30$ overlapping, $U=40$ unique, and $T=5$
  trivial sample points.}
